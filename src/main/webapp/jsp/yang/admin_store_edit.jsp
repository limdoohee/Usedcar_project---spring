			...
			<div id="content">
				...
				<div id="manage_list">
					<ul class="list_category">
						<h3>전시장 수정</h3>
						<form action = "admin_store_edit_ok.str" method = "post" onsubmit = "return check()">
							<table class = "tbn">
								<tr>
									<td>
										<label class="icon" for="name"><i class="icon-credit-card"></i></label>
										<input type = "text" name = "store_no" id = "store_no" value = "${store.store_no }" readonly>
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<input type = "text" name = "store_location" id = "store_location" value = "${store.store_location }">
									</td>
								</tr>
								...
								<tr>
									<td>
										...
										<input type = "text" name = "store_tel" id = "store_tel" value = "${store.store_tel }">
									</td>
								</tr>
							</table>
