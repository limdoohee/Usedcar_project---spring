...
<body>
	...
	<div id="board_page">
		<ul>
		<c:if test="${page > 1}">
			<li><a href="javascript:void(0)" class="board_page_before_search"><img src="resources/images/page-back.png"></a><li>
		</c:if>
		<c:forEach var="a" begin="${startpage}" end="${endpage}">
			...
			<c:if test="${a != page}">
				<li><a href="javascript:void(0)" class="board_page_on_search">${a}</a><li>
			</c:if>
		</c:forEach>
		<c:if test="${page < maxpage}">
			<li><a href="javascript:void(0)" class="board_page_after_search"><img src="resources/images/page-front.png"></a><li>
		</c:if>
		</ul>
	</div> <!-- board_page 끝 -->
