...
<script type="text/javascript" src="resources/js/board_write.js" charset="utf-8"></script>
		...
		<div id="main">
			<div id="content">
				...
				<div id="board_cont">
					...
					<form action="board_write_ok.bo?state=modify" onsubmit="return check()" method="post" enctype="multipart/form-data">
					<div id="car_choice">
						<img src="resources/upload/car/no_image.jpg" id="car_image" style="width:150px;"> 
						<div id="car_con">
							<ul>
						...
						<tbody id="board_write">
							<tr>
								<td>
									...
									<div class="float"><input type="text" id="board_name" name="board_name" class="input-1" value="${board.board_name}" required></div>
								</td>
								<td>
							...
							<tr>
								<td colspan="2">
									...
									<div class="float"><input id="subject" type="text" name="board_subject" class="input-2" value="${board.board_subject}" readonly></div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
